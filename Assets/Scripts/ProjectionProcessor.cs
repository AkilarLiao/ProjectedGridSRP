...
namespace ProjectedGrid
{
	...
	{	
		...
		//avoid see the screen boder(happen noise vertex), like camera linear plane
		float GetOffestRange();
	}
	public class ProjectionProcessor
	{
		...
		public IProjectionProcessor TheProjectionProcessor { get; set; }
		...
		public void UpdateProjection(Camera cam, ref Matrix4x4 inProjectorVP, ref Matrix4x4 inInterpolation)
		{
			if (cam == null) return;
			...
			inProjectorVP = m_projectorR.inverse * projectorVP;
			inInterpolation = m_projectorI;
		}
		...
		void AimProjector(Camera cam)
		{
			...
			float level =
				//TheProjectionProcessor != null ? TheProjectionProcessor.GetOceanHeight() : 0.0f;
				TheProjectionProcessor != null ? TheProjectionProcessor.GetPlaneHeight() : 0.0f;
			float range =
				//TheProjectionProcessor != null ? TheProjectionProcessor.GetOceaRange() : 1.0f;
				TheProjectionProcessor != null ? TheProjectionProcessor.GetOffestRange() : 1.0f;
